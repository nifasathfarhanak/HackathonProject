...
def create_jira_issues(jira_server: str, jira_email: str, jira_token: str, project_key: str, test_cases: list):
    ...
    Args:
        jira_server: The URL of the Jira server (e.g., 'https://your-domain.atlassian.net').
        jira_email: The email address of the user to authenticate with.
        jira_token: The API token for the user.
        project_key: The key of the Jira project (e.g., 'PROJ').
        test_cases: A list of detailed test case dictionaries generated by the AI.

    Returns:
        A list of strings confirming the creation of each issue or reporting errors.
    """
    ...
    for test_case in test_cases:
        ...
        issue_dict = {
            ...
            # IMPORTANT: The issue type name must match exactly what is in your Jira project.
            # Common names are 'Test', 'Task', 'Story', or a custom type like 'Test Case'.
            'issuetype': {'name': 'Task'} 
        }
